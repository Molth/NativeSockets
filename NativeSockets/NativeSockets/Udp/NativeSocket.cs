...
namespace NativeSockets
{
    ...
    public readonly struct NativeSocket : IDisposable, IEquatable<NativeSocket>, IComparable<NativeSocket>
    {
        ...
        /// <param name="result">
        ///     When this method returns, contains the created native socket,
        ...
        {
            SocketError error = SocketPal.Create(ipv6, out nint handle);
            result = new NativeSocket(handle, ipv6 ? AddressFamily.InterNetworkV6 : AddressFamily.InterNetwork);
            return error;
        }
