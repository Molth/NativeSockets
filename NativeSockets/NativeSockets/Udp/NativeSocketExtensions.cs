...
namespace NativeSockets
{
    ...
    public static unsafe class NativeSocketExtensions
    {
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise an error code.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError PollFlags(this NativeSocket socket, int microseconds, SelectModeFlags mode, out SelectModeFlags status) => SocketPal.PollFlags(socket, microseconds, mode, out status);
