...
{
    /// <summary>
    ///     Indicates that the decorated target must be pinned (fixed in memory)
    ///     to prevent garbage collection from relocating it.
    /// </summary>
    [AttributeUsage(AttributeTargets.Constructor | AttributeTargets.Method | AttributeTargets.Property | AttributeTargets.Parameter)]
    internal sealed class MustBePinnedAttribute : Attribute
    {
        /// <summary>
