...
namespace NativeSockets.Udp
{
    public static class XxHash32
    {
        ...
        public static uint GenerateSeed()
        {
            ...
            ref byte local = ref MemoryMarshal.GetReference(data);
        ...
        public static int Hash(ReadOnlySpan<byte> buffer, uint seed = 0)
        {
            ...
            ref byte local2 = ref Unsafe.Add(ref local1, buffer.Length);
#else
            ref byte local2 = ref Unsafe.Add(ref local1, (nint)buffer.Length);
#endif
            if (buffer.Length >= 16)
            {
