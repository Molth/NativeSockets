...
namespace NativeSockets
{
    ...
    internal static unsafe class SharedSocketPal
    {
        ...
        static SharedSocketPal()
        {
            ...
            ADDRESS_FAMILY_INTER_NETWORK_V4 = SharedNativeLib.GetAddressFamilyInterNetworkV4();
            ADDRESS_FAMILY_INTER_NETWORK_V6 = SharedNativeLib.GetAddressFamilyInterNetworkV6();
        ...
        public static SocketError GetLastSocketError() => SharedNativeLib.GetLastSocketError();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError Startup() => SharedNativeLib.Startup();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError Cleanup() => SharedNativeLib.Cleanup();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static nint Create(bool ipv6) => SharedNativeLib.Create(ipv6 ? 1 : 0);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise <see cref="SocketError.SocketError" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError Close(nint socket) => SharedNativeLib.Close(socket);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise an error code.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError SetDualModeIpv6(nint socket, bool dualMode) => SharedNativeLib.SetDualModeIpv6(socket, dualMode ? 1 : 0);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise <see cref="SocketError.SocketError" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError BindIpv4(nint socket, sockaddr_in4* socketAddress) => SharedNativeLib.BindIpv4(socket, socketAddress);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise <see cref="SocketError.SocketError" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError BindIpv6(nint socket, sockaddr_in6* socketAddress) => SharedNativeLib.BindIpv6(socket, socketAddress);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise <see cref="SocketError.SocketError" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError ConnectIpv4(nint socket, sockaddr_in4* socketAddress) => SharedNativeLib.ConnectIpv4(socket, socketAddress);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise <see cref="SocketError.SocketError" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError ConnectIpv6(nint socket, sockaddr_in6* socketAddress) => SharedNativeLib.ConnectIpv6(socket, socketAddress);
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError SetOption(nint socket, SocketOptionLevel level, SocketOptionName name, byte* value, int length) => SharedNativeLib.SetOption(socket, level, name, value, length);
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError GetOption(nint socket, SocketOptionLevel level, SocketOptionName name, byte* value, int* length) => SharedNativeLib.GetOption(socket, level, name, value, length);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise an error code.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError SetRawOption(nint socket, int level, int name, byte* value, int length) => SharedNativeLib.SetRawOption(socket, level, name, value, length);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise an error code.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError GetRawOption(nint socket, int level, int name, byte* value, int* length) => SharedNativeLib.GetRawOption(socket, level, name, value, length);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise an error code.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError SetBlocking(nint socket, bool blocking) => SharedNativeLib.SetBlocking(socket, blocking ? 1 : 0);
        ...
        {
            SocketError result = SharedNativeLib.Poll(socket, microseconds, mode, out int statusI32);
            status = statusI32 != 0;
            return result;
        }
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise an error code.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError PollFlags(nint socket, int microseconds, SelectModeFlags inFlags, out SelectModeFlags outFlags) => SharedNativeLib.PollFlags(socket, microseconds, inFlags, out outFlags);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int Send(nint socket, void* buffer, int length, SocketFlags socketFlags) => SharedNativeLib.Send(socket, buffer, length, socketFlags);
        ...
        /// <returns>The number of bytes sent, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int SendToIpv4(nint socket, void* buffer, int length, SocketFlags socketFlags, sockaddr_in4* socketAddress) => SharedNativeLib.SendToIpv4(socket, buffer, length, socketFlags, socketAddress);
        ...
        /// <returns>The number of bytes sent, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int SendToIpv6(nint socket, void* buffer, int length, SocketFlags socketFlags, sockaddr_in6* socketAddress) => SharedNativeLib.SendToIpv6(socket, buffer, length, socketFlags, socketAddress);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int Receive(nint socket, void* buffer, int length, SocketFlags socketFlags) => SharedNativeLib.Receive(socket, buffer, length, socketFlags);
        ...
        /// <returns>The number of bytes received, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ReceiveFromIpv4(nint socket, void* buffer, int length, SocketFlags socketFlags, sockaddr_in4* socketAddress) => SharedNativeLib.ReceiveFromIpv4(socket, buffer, length, socketFlags, socketAddress);
        ...
        /// <returns>The number of bytes received, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ReceiveFromIpv6(nint socket, void* buffer, int length, SocketFlags socketFlags, sockaddr_in6* socketAddress) => SharedNativeLib.ReceiveFromIpv6(socket, buffer, length, socketFlags, socketAddress);
        ...
        /// <returns>The number of bytes sent, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int SendVectored(nint socket, NativeIoSlice* buffers, int bufferCount, SocketFlags socketFlags) => SharedNativeLib.SendVectored(socket, buffers, bufferCount, socketFlags);
        ...
        /// <returns>The number of bytes sent, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int SendToVectoredIpv4(nint socket, NativeIoSlice* buffers, int bufferCount, SocketFlags socketFlags, sockaddr_in4* socketAddress) => SharedNativeLib.SendToVectoredIpv4(socket, buffers, bufferCount, socketFlags, socketAddress);
        ...
        /// <returns>The number of bytes sent, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int SendToVectoredIpv6(nint socket, NativeIoSlice* buffers, int bufferCount, SocketFlags socketFlags, sockaddr_in6* socketAddress) => SharedNativeLib.SendToVectoredIpv6(socket, buffers, bufferCount, socketFlags, socketAddress);
        ...
        /// <returns>The number of bytes received, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ReceiveVectored(nint socket, NativeIoSlice* buffers, int bufferCount, SocketFlags* inOutFlags) => SharedNativeLib.ReceiveVectored(socket, buffers, bufferCount, inOutFlags);
        ...
        /// <returns>The number of bytes received, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ReceiveFromVectoredIpv4(nint socket, NativeIoSlice* buffers, int bufferCount, SocketFlags* inOutFlags, sockaddr_in4* socketAddress) => SharedNativeLib.ReceiveFromVectoredIpv4(socket, buffers, bufferCount, inOutFlags, socketAddress);
        ...
        /// <returns>The number of bytes received, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ReceiveFromVectoredIpv6(nint socket, NativeIoSlice* buffers, int bufferCount, SocketFlags* inOutFlags, sockaddr_in6* socketAddress) => SharedNativeLib.ReceiveFromVectoredIpv6(socket, buffers, bufferCount, inOutFlags, socketAddress);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise <see cref="SocketError.SocketError" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError GetNameIpv4(nint socket, sockaddr_in4* socketAddress) => SharedNativeLib.GetNameIpv4(socket, socketAddress);
