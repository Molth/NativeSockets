...
namespace NativeSockets
{
    ...
    internal static unsafe class IosSocketPal
    {
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise an error code.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError PollFlags(nint socket, int microseconds, SelectModeFlags mode, out SelectModeFlags status) => IosNativeLib.PollFlags(socket, microseconds, mode, out status);
