...
namespace NativeSockets
{
    ...
    /// </summary>
    internal static unsafe class DynamicSocketPal
    {
        /// <summary>
        ///     Initializes a new instance of this class.
        /// </summary>
        static DynamicSocketPal()
        {
            if (
            ...
            ADDRESS_FAMILY_INTER_NETWORK_V4 = DynamicNativeLib.GetAddressFamilyInterNetworkV4();
            ADDRESS_FAMILY_INTER_NETWORK_V6 = DynamicNativeLib.GetAddressFamilyInterNetworkV6();
        ...
        public static SocketError GetLastSocketError() => DynamicNativeLib.GetLastSocketError();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError Startup() => DynamicNativeLib.Startup();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError Cleanup() => DynamicNativeLib.Cleanup();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static nint Create(bool ipv6) => DynamicNativeLib.Create(ipv6 ? 1 : 0);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise <see cref="SocketError.SocketError" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError Close(nint socket) => DynamicNativeLib.Close(socket);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise an error code.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError SetDualModeIpv6(nint socket, bool dualMode) => DynamicNativeLib.SetDualModeIpv6(socket, dualMode ? 1 : 0);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise <see cref="SocketError.SocketError" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError BindIpv4(nint socket, sockaddr_in4* socketAddress) => DynamicNativeLib.BindIpv4(socket, socketAddress);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise <see cref="SocketError.SocketError" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError BindIpv6(nint socket, sockaddr_in6* socketAddress) => DynamicNativeLib.BindIpv6(socket, socketAddress);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise <see cref="SocketError.SocketError" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError ConnectIpv4(nint socket, sockaddr_in4* socketAddress) => DynamicNativeLib.ConnectIpv4(socket, socketAddress);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise <see cref="SocketError.SocketError" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError ConnectIpv6(nint socket, sockaddr_in6* socketAddress) => DynamicNativeLib.ConnectIpv6(socket, socketAddress);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise an error code.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError SetOption(nint socket, SocketOptionLevel level, SocketOptionName name, byte* value, int length) => DynamicNativeLib.SetOption(socket, level, name, value, length);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise an error code.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError GetOption(nint socket, SocketOptionLevel level, SocketOptionName name, byte* value, int* length) => DynamicNativeLib.GetOption(socket, level, name, value, length);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise an error code.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError SetBlocking(nint socket, bool blocking) => DynamicNativeLib.SetBlocking(socket, blocking ? 1 : 0);
        ...
        {
            SocketError result = DynamicNativeLib.Poll(socket, microseconds, mode, out int statusI32);
            status = statusI32 != 0;
            return result;
        }
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise an error code.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError PollFlags(nint socket, int microseconds, SelectModeFlags inFlags, out SelectModeFlags outFlags) => DynamicNativeLib.PollFlags(socket, microseconds, inFlags, out outFlags);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int Send(nint socket, void* buffer, int length, SocketFlags socketFlags) => DynamicNativeLib.Send(socket, buffer, length, socketFlags);
        ...
        /// <returns>The number of bytes sent, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int SendToIpv4(nint socket, void* buffer, int length, SocketFlags socketFlags, sockaddr_in4* socketAddress) => DynamicNativeLib.SendToIpv4(socket, buffer, length, socketFlags, socketAddress);
        ...
        /// <returns>The number of bytes sent, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int SendToIpv6(nint socket, void* buffer, int length, SocketFlags socketFlags, sockaddr_in6* socketAddress) => DynamicNativeLib.SendToIpv6(socket, buffer, length, socketFlags, socketAddress);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int Receive(nint socket, void* buffer, int length, SocketFlags socketFlags) => DynamicNativeLib.Receive(socket, buffer, length, socketFlags);
        ...
        /// <returns>The number of bytes received, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ReceiveFromIpv4(nint socket, void* buffer, int length, SocketFlags socketFlags, sockaddr_in4* socketAddress) => DynamicNativeLib.ReceiveFromIpv4(socket, buffer, length, socketFlags, socketAddress);
        ...
        /// <returns>The number of bytes received, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ReceiveFromIpv6(nint socket, void* buffer, int length, SocketFlags socketFlags, sockaddr_in6* socketAddress) => DynamicNativeLib.ReceiveFromIpv6(socket, buffer, length, socketFlags, socketAddress);
        ...
        /// <returns>The number of bytes sent, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int SendVectored(nint socket, NativeIoSlice* buffers, int bufferCount, SocketFlags socketFlags) => DynamicNativeLib.SendVectored(socket, buffers, bufferCount, socketFlags);
        ...
        /// <returns>The number of bytes sent, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int SendToVectoredIpv4(nint socket, NativeIoSlice* buffers, int bufferCount, SocketFlags socketFlags, sockaddr_in4* socketAddress) => DynamicNativeLib.SendToVectoredIpv4(socket, buffers, bufferCount, socketFlags, socketAddress);
        ...
        /// <returns>The number of bytes sent, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int SendToVectoredIpv6(nint socket, NativeIoSlice* buffers, int bufferCount, SocketFlags socketFlags, sockaddr_in6* socketAddress) => DynamicNativeLib.SendToVectoredIpv6(socket, buffers, bufferCount, socketFlags, socketAddress);
        ...
        /// <returns>The number of bytes received, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ReceiveVectored(nint socket, NativeIoSlice* buffers, int bufferCount, SocketFlags* inOutFlags) => DynamicNativeLib.ReceiveVectored(socket, buffers, bufferCount, inOutFlags);
        ...
        /// <returns>The number of bytes received, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ReceiveFromVectoredIpv4(nint socket, NativeIoSlice* buffers, int bufferCount, SocketFlags* inOutFlags, sockaddr_in4* socketAddress) => DynamicNativeLib.ReceiveFromVectoredIpv4(socket, buffers, bufferCount, inOutFlags, socketAddress);
        ...
        /// <returns>The number of bytes received, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ReceiveFromVectoredIpv6(nint socket, NativeIoSlice* buffers, int bufferCount, SocketFlags* inOutFlags, sockaddr_in6* socketAddress) => DynamicNativeLib.ReceiveFromVectoredIpv6(socket, buffers, bufferCount, inOutFlags, socketAddress);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise <see cref="SocketError.SocketError" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError GetNameIpv4(nint socket, sockaddr_in4* socketAddress) => DynamicNativeLib.GetNameIpv4(socket, socketAddress);
        ...
        /// <returns><see cref="SocketError.Success" /> on success; otherwise <see cref="SocketError.SocketError" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SocketError GetNameIpv6(nint socket, sockaddr_in6* socketAddress) => DynamicNativeLib.GetNameIpv6(socket, socketAddress);
        ...
        public static SocketError SetIpIpv4(sockaddr_in4* socketAddress, ReadOnlySpan<byte> ip)
        {
            ...
            {
                return DynamicNativeLib.SetIpIpv4(socketAddress, pStringBuf, ip.Length);
            }
        }
        ...
        public static SocketError SetIpIpv6(sockaddr_in6* socketAddress, ReadOnlySpan<byte> ip)
        {
            fixed (byte* pStringBuf = &MemoryMarshal.GetReference(ip))
            {
                return DynamicNativeLib.SetIpIpv6(socketAddress, pStringBuf, ip.Length);
            }
        }
        ...
        public static SocketError GetIpIpv4(sockaddr_in4* socketAddress, Span<byte> ip)
        {
            fixed (byte* pStringBuf = &MemoryMarshal.GetReference(ip))
            {
                return DynamicNativeLib.GetIpIpv4(socketAddress, pStringBuf, ip.Length);
            }
        }
        ...
        public static SocketError GetIpIpv6(sockaddr_in6* socketAddress, Span<byte> ip)
        {
            fixed (byte* pStringBuf = &MemoryMarshal.GetReference(ip))
            {
                return DynamicNativeLib.GetIpIpv6(socketAddress, pStringBuf, ip.Length);
            }
        }
        ...
        public static SocketError SetHostNameIpv4(sockaddr_in4* socketAddress, ReadOnlySpan<byte> hostName)
        {
            ...
            {
                return DynamicNativeLib.SetHostNameIpv4(socketAddress, pStringBuf, hostName.Length);
            }
        }
        ...
        public static SocketError SetHostNameIpv6(sockaddr_in6* socketAddress, ReadOnlySpan<byte> hostName)
        {
            fixed (byte* pStringBuf = &MemoryMarshal.GetReference(hostName))
            {
                return DynamicNativeLib.SetHostNameIpv6(socketAddress, pStringBuf, hostName.Length);
            }
        }
        ...
        public static SocketError GetHostNameIpv4(sockaddr_in4* socketAddress, Span<byte> hostName)
        {
            fixed (byte* pStringBuf = &MemoryMarshal.GetReference(hostName))
            {
                return DynamicNativeLib.GetHostNameIpv4(socketAddress, pStringBuf, hostName.Length);
            }
        }
        ...
        public static SocketError GetHostNameIpv6(sockaddr_in6* socketAddress, Span<byte> hostName)
        {
            fixed (byte* pStringBuf = &MemoryMarshal.GetReference(hostName))
            {
                return DynamicNativeLib.GetHostNameIpv6(socketAddress, pStringBuf, hostName.Length);
            }
        }
    }
}