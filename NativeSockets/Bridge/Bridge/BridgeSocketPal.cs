...
namespace NativeSockets
{
    ...
    internal static unsafe class BridgeSocketPal
    {
        ...
        /// <returns>The number of bytes received, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ReceiveVectored(nint socket, NativeIoSlice* buffers, int bufferCount, SocketFlags* inOutFlags) => BridgeNativeLib.ReceiveVectored(socket, buffers, bufferCount, inOutFlags);
        ...
        /// <returns>The number of bytes received, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ReceiveFromVectoredIpv4(nint socket, NativeIoSlice* buffers, int bufferCount, SocketFlags* inOutFlags, sockaddr_in4* socketAddress) => BridgeNativeLib.ReceiveFromVectoredIpv4(socket, buffers, bufferCount, inOutFlags, socketAddress);
        ...
        /// <returns>The number of bytes received, or -1 on error.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ReceiveFromVectoredIpv6(nint socket, NativeIoSlice* buffers, int bufferCount, SocketFlags* inOutFlags, sockaddr_in6* socketAddress) => BridgeNativeLib.ReceiveFromVectoredIpv6(socket, buffers, bufferCount, inOutFlags, socketAddress);
